...
#Model只是一个基类，通过元类metaclass：ModelMetaclass, 任何继承自Model的类（比如User）会自动通过ModelMetaclass扫描映射关系，
#并存储到自身的类属性(如__table__、__mappings__...)中, 可以将具体的子类User的映射信息读取出来：
